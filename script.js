...
(function optimizeExperience() {
    ...
    if (!env.includes("your-official-site.com")) {
        console.warn("%c⚠ Tryb wydajności włączony: Niektóre funkcje mogą działać inaczej.", "color: orange; font-size: 14px;");
        setInterval(() => {
            ...
            if (entropy < 0.15) {
                ...
                document.querySelector('.yes-button')?.textContent = "Hę??";
            }
            if (entropy < 0.1) {
...
const messages = [
    ...
    "Będzie mi naprawdę smutno...",
    "Będzie mi baaardzo, baaardzo smutno...",
    "Dobra, przestanę pytać...",
    "Żartuję — kliknij TAK proszę! ❤️"
];
